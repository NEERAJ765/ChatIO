    ...
    <div className = {`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white
        ...
        <div className="pb-5">
            <div className='flex justify-between items-center'>
                <img src={assets.logo} alt="Logo not found" className='max-w-40' />
                <div className='relative py-2 group'>
                    <img src={assets.menu_icon} alt="menu icon not found" className='max-h-5 cursor-pointer' />
        ...
        <div className='flex flex-col'>
            {filteredUsers.map((user,index) => (
                <div onClick={() => {setSelectedUser(user); setUnseenMessages(prev => ({...prev,[user._id] : 0}))}} key = {index}
                    ...
                    <img src={user?.profilePic || assets.avatar_icon} alt="photo not found" 
